...
contract('SupplyChain', function(accounts) {
    ...
    before('setup of accounts', async function () {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        // see down below for details on how I check the emitted event 'Harvested'
        ...
        // these following lines are basically taken from https://dappsdev.org/hands-on/testing/solidity-events
        // inspect the transaction & perform assertions on the logs
        const { logs } = tx;
        assert.ok(Array.isArray(logs));
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'Harvested', 'Invalid event emitted');
    })    
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        // see down below for details on how I check the emitted event 'Processed'
        ...
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'Processed', 'Invalid event emitted');
    })    
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        // see down below for details on how I check the emitted event 'Packed'
        ...
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'Packed', 'Invalid event emitted');
    })    
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // see down below for details on how I check the emitted event 'ForSale'
        ...
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'ForSale', 'Invalid event emitted');
    })    
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // see down below for details on how I check the emitted event 'Sold'
        ...
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'Sold', 'Invalid event emitted');
    })    
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // see down below for details on how I check the emitted event 'Shipped'
        ...
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'Shipped', 'Invalid event emitted');
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        // see down below for details on how I check the emitted event 'Received'
        ...
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'Received', 'Invalid event emitted');
    })    
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        // see down below for details on how I check the emitted event 'Purchased'
        ...
        assert.equal(logs.length, 1);
        const log = logs[0];
        assert.equal(log.event, 'Purchased', 'Invalid event emitted');
    })    
